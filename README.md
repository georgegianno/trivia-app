...
- It's purpose is to demonstrate several concepts I am familiar with. It consumes Trivia API to populate a database with questions and answers, with one-off sync.<br>
